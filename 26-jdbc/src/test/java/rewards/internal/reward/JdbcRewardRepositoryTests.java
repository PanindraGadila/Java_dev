...
public class JdbcRewardRepositoryTests {
	...
	private void verifyRewardInserted(RewardConfirmation confirmation, Dining dining) throws SQLException {
		...
		String slq = "SELECT * FROM T_REWARD WHERE CONFIRMATION_NUMBER = ?";
		Map<String, Object> values = jdbcTemplate.queryForMap(slq, confirmation.getConfirmationNumber());
...
//		Map<String, Object> values = null;
	...
	private int getRewardCount() throws SQLException {
		...
		return jdbcTemplate.queryForObject("SELECT COUNT(*) FROM T_REWARD;\n", Integer.class);
//		return -1;
	}
